Contributing to BitcoinNox Core
============================

The BitcoinNox Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinNox Core project, and is not to be
confused with overall BitcoinNox Network Protocol consensus changes.

Whether a pull request is merged into BitcoinNox Core rests with the project merge
...
Patches that change BitcoinNox consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinNox consensus, it must have been
...
The project leader is the release manager for each BitcoinNox Core release.
