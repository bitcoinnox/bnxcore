...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinnox-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoinnox-cli.cpp \
           src/bitcoinnox-tx.cpp \
           src/bitcoinnox.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoinnox.cpp \
           src/qt/bitcoinnoxstrings.cpp \
...
RESOURCES += src/qt/bitcoinnox.qrc src/qt/bitcoinnox_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinnox_bg.ts \
                src/qt/locale/bitcoinnox_de.ts \
                src/qt/locale/bitcoinnox_en.ts \
                src/qt/locale/bitcoinnox_es.ts \
                src/qt/locale/bitcoinnox_fi.ts \
                src/qt/locale/bitcoinnox_fr.ts \
                src/qt/locale/bitcoinnox_it.ts \
                src/qt/locale/bitcoinnox_ja.ts \
                src/qt/locale/bitcoinnox_pl.ts \
                src/qt/locale/bitcoinnox_pt.ts \
                src/qt/locale/bitcoinnox_ru.ts \
                src/qt/locale/bitcoinnox_sk.ts \
                src/qt/locale/bitcoinnox_sv.ts \
                src/qt/locale/bitcoinnox_vi.ts \
                src/qt/locale/bitcoinnox_zh_CN.ts \
                src/qt/locale/bitcoinnox_zh_TW.ts
