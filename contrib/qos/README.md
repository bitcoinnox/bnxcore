...
This means one can have an always-on bitcoinnoxd instance running, and another local bitcoinnoxd/bitcoinnox-qt instance which connects to this node and receives blocks from it.
