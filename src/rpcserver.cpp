...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitcoinNox server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitcoinNox server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinNox features */
        {"bitcoinnox", "masternode", &masternode, true, true, false},
        {"bitcoinnox", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinnox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinnox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinnox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinnox", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinnox", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinnox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinnox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinnox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinnox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinnox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinnox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinnox", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinnox", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinnox", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinnox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinnox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinnox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinnox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinnox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinnox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinnox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinnox", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinnox", "mnsync", &mnsync, true, true, false},
        {"bitcoinnox", "spork", &spork, true, true, false},
        {"bitcoinnox", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcoinnox", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcoinnoxd, or the -server option to bitcoinnox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"BitcoinNox Alert\" admin@foo.com\n"),
...
{
    return "> bitcoinnox-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20222/\n";
}
