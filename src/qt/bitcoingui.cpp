                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinNox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinNox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinnox: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBNX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinNox Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinNox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinNox"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinNox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinNox addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitcoinNox: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinNox Core help message to get a list with possible BitcoinNox command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinNox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinNox network", "", count));
}
...
{
    QString strTitle = tr("BitcoinNox Core"); // default title
