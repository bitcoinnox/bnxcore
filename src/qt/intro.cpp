...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinNox Core"),
     ...
     * override -datadir in the bitcoinnox.conf file in the default data directory
     * (to be consistent with bitcoinnoxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
