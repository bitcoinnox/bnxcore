...
public:
    ...
    void setZBitcoinNoxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBNX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBNX_clicked();
    void on_pushButtonZBitcoinNoxControl_clicked();
