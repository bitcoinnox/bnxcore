...
/** Utility functions used by the BitcoinNox Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinNox addresses in monospace font
...
// Parse "bitcoinnox:" URI into recipient object, return true on successful parsing
