                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitcoinNox from zBitcoinNox"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBitcoinNox"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBitcoinNox));
