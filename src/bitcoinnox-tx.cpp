...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinNox Core bitcoinnox-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinnox-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinnox transaction") + "\n" +
                               "  bitcoinnox-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinnox transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinnox transaction
