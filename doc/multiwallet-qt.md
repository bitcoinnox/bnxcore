...
In order to support loading of multiple wallets in bitcoinnox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinnox.cpp.
...
Changes to bitcoinnox.cpp
----------------------
bitcoinnox.cpp is the entry point into bitcoinnox-qt, and as such, will require some minor modifications to provide hooks for
